        ...
        <div class="groupsdetails-box">
            ...
            <div class="groups-avata">
                <div class="groups-avata-img">
                      <ul class="colonel">
                          <li><img src="../assets/images/user-img0.jpg"></li>
                          <li><img src="../assets/images/tx2.jpg"></li>
                          <li><img src="../assets/images/tx2.jpg"></li>
                      </ul>
                </div> 
                ...
                <div class="man-name">
                    <ul>
                        <li class="colonel"><div class="man-name-img fl"><img src="../assets/images/user-img0.jpg"></div>团长郭小帅<span>2015-12-25 17:00:00</span></li>
                        <li><div class="man-name-img fl"><img src="../assets/images/tx2.jpg"></div>座位没主人，快去邀请好友占领吧</li>
                        <li><div class="man-name-img fl"><img src="../assets/images/tx2.jpg"></div>座位没主人，快去邀请好友占领吧</li>
                    </ul> 
                </div>
            </div>
